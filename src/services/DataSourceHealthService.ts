...
export const KNOWN_DATA_SOURCES: DataSourceDefinition[] = [
  ...
  },
  {
    ...
    category: 'KRIPTO',
    primaryUrl: 'https://api.binance.com/api/v3/ticker/24hr',
    checkMethod: 'GET',
    expectedType: 'json',
  ...
  },
  {
    ...
    category: 'GLOBAL',
    primaryUrl: 'https://finance.yahoo.com/',
    checkMethod: 'GET',
    expectedType: 'html',
    description: 'ABD borsalarındaki en büyük 1.000 şirketin fiyat, bilanço ve değerleme oranları.',
  },
  {
    id: 'us_etfs',
    name: 'ABD ETF Fonları (Borsada İşlem Gören Fonlar)',
    category: 'GLOBAL',
    primaryUrl: 'https://www.ssga.com/us/en/intermediary/etfs',
    checkMethod: 'GET',
    expectedType: 'html',
    description: 'S&P 500, QQQ, SCHD gibi dev ABD endeks fonları, yönetim altındaki varlık ve getiri metrikleri.',
  },
  {
    id: 'analyst_commentary',
    name: 'Kurumsal Analist Raporları',
    category: 'HABER',
    primaryUrl: 'https://seekingalpha.com/',
    checkMethod: 'GET',
    expectedType: 'html',
    description: 'Goldman Sachs, Morgan Stanley, JPM gibi kurumların fiyat hedefleri ve boğa/ayı tezleri.',
  },
  {
    id: 'kap_fund_portfolios',
    name: 'KAP Fon Portföy Dağılım Raporları',
    category: 'KAP',
    primaryUrl: 'https://www.kap.org.tr/tr/api/disclosure/list/main',
    checkMethod: 'GET',
    expectedType: 'json',
    description: 'Yatırım fonlarının (TEFAS) aylık hisse ve varlık dağılım raporları (PDF/Excel scraping).',
  },
];
